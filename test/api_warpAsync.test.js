...
describe('gdal', () => {
  ...
  describe('reprojectImageAsync()', () => {
    ...
    it('should throw if cutline is wrong geometry type', () => {
      ...
      assert.isRejected(gdal.reprojectImageAsync(options))
    })
    it('should throw if src dataset has been closed', () => {
      ...
      assert.isRejected(gdal.reprojectImageAsync(options), 'src dataset already closed')
    })
    it('should throw if dst dataset has been closed', () => {
      ...
      options.dst.close()
      assert.isRejected(gdal.reprojectImageAsync(options), 'dst dataset already closed')
    })
    ...
    it('should use additional stringlist options', () => {
      ...
      const p = gdal.reprojectImageAsync(options)
      assert.isFulfilled(p)

 ...
 * @for gdal.GeometryCollectionChildren
 * @method toArray
 * @return {Array} List of {{#crossLink "Geometry"}}Geometry{{/crossLink}} instances.
 */
 ...
 * @for gdal.LineStringPoints
 * @method toArray
 * @return {Array} List of {{#crossLink "Point"}}Point{{/crossLink}} instances.
 */
 ...
 * @for gdal.PolygonRings
 * @method toArray
 * @return {Array} List of {{#crossLink "LineString"}}Linestring{{/crossLink}} instances.
 */
 ...
 * @param {number} [data_type] Used when creating a raster dataset with the `"w"` mode.

...
gdal.RasterBandPixels.prototype.readPromise = (function() {
  ...
  return function(x, y, w, h, data, bufw, bufh, type, pspace, lspace) {
    return readPromise.call(this, x, y, w, h, data, bufw, bufh, type, pspace, lspace)
  }
})()

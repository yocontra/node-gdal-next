...
template <typename K, typename W> class ObjectCache {
  ...
  ~ObjectCache();
    ...
    private:
  static void
  release(ObjectCacheItem<K> *item, ObjectCacheItemStatus status_change);
  static void
                                      cacheWeakCallback(const Nan::WeakCallbackInfo<ObjectCacheItem<K>> &data);
...
ObjectCache<K, W>::ObjectCache() : cache(), aliases() {
}
...
template <typename K, typename W>
void ObjectCache<K, W>::cacheWeakCallback(
  const Nan::WeakCallbackInfo<ObjectCacheItem<K>> &data) {
...
template <typename K, typename W>
void ObjectCache<K, W>::release(
  ObjectCacheItem<K> *item, ObjectCacheItemStatus status_change) {

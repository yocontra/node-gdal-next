...
/* find whether or not have <malloc.h> - defined in the gyp */

/* check if function `aligned_alloc` exists */
/* #undef OPJ_HAVE_ALIGNED_ALLOC */
/* check if function `_aligned_malloc` exists */
/* #undef OPJ_HAVE__ALIGNED_MALLOC */
/* check if function `memalign` exists - defined in the gyp */
/* check if function `posix_memalign` exists - defined in the gyp */

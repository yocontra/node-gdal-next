	...
	"targets": [
		{
			...
			"sources": [
				...
				"../gdal/frmts/gtiff/gtiffsplitband.cpp",
				"../gdal/frmts/gtiff/gtiffsplitbitmapband.cpp",
				"../gdal/frmts/gtiff/gtiffrgbaband.cpp",
				"../gdal/frmts/gtiff/generate_quant_table_md5sum.cpp",
				"../gdal/frmts/gtiff/gtiffdataset_write.cpp",
				"../gdal/frmts/gtiff/gtiffdataset.cpp",
				"../gdal/frmts/gtiff/gtiffbitmapband.cpp",
				"../gdal/frmts/gtiff/gt_wkt_srs.cpp",
				"../gdal/frmts/gtiff/geotiff.cpp",
				"../gdal/frmts/gtiff/gtiffrasterband_read.cpp",
				"../gdal/frmts/gtiff/gtiffoddbitsband.cpp",
				...
				"../gdal/frmts/gtiff/libtiff/tif_lerc.c",
				...
				"../gdal/frmts/gtiff/gtiffjpegoverviewds.cpp",
				"../gdal/frmts/gtiff/gt_citation.cpp",
				"../gdal/frmts/gtiff/gt_jpeg_copy.cpp",
				"../gdal/frmts/gtiff/gtiffrasterband.cpp",
				"../gdal/frmts/gtiff/gt_overview.cpp",
				"../gdal/frmts/gtiff/gtiffdataset_read.cpp",
				"../gdal/frmts/gtiff/gtiffrasterband_write.cpp",
